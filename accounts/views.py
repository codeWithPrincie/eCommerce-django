...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()
            #messages.success(request, 'Thankyou for registering with us. We have sent you verification email to your email address. Please verify it.')
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    #Getting the productvariation by cart id
                    product_variation = []
                    for item in cart_item:
                        variation = item.variations.all()
                        product_variation.append(list(variation))
                    
                    # Get the caet items from the user to access his product variation
...
#Activation of user using the link generated in email address
