    ...
    if current_user.is_authenticated:
        ...
        if request.method == 'POST':
            for item in request.POST:
                ...
                try:
                    variation = Variation.objects.get(product = product, variation__iexact=key, variation_value__iexact=value)
        ...
        try:
            cart = Cart.objects.get(cart_id=_cart_id(request)) # get the cart usng the cart id presentin session
